...
import './App.css';
import abhiImage from "./Teju.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Sai Tejaswini" />
          <h3 className="name">Sai Tejaswini</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Sai Tejaswini</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Sai Tejaswini </h3>
            <h3> <span> Qualification : </span> B.Tech 3rd year </h3>
            <h3> <span> Address</span> Nellore</h3>
            <h3> <span> Strengths : </span> Consistency,Smartwork.Dedication </h3>
            <h3> <span> Hobbies: </span> Exploring,Traveling</h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>Sri chaitanya Techno School,Nellore</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i>saitejaswini0103@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9700880708  </h3>
